...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('usuarios', function (Blueprint $table) {
            ...
            // FK para TiposUsuario (define o papel)
            ...
            $table->string('creci', 50)->nullable(); // Apenas para corretores
            $table->string('cargo', 100)->nullable(); // Apenas para funcionários
            $table->string('foto_url', 255)->nullable();
            $table->string('matricula', 20)->unique()->nullable(); // Apenas para funcionários
            
            // FK opcional para Imobiliarias (se for funcionário de uma imobiliária)
